...
function seleccionarFecha() {
    ...
    inputFecha.addEventListener('input', function(e) {
        ...
        if([6, 0].includes(dia) ) {
            e.target.value = '';
            mostrarAlerta('* Fines de semana no disponibles', 'error', '.form');
        } else {
...
function seleccionarHora() {
    ...
    inputHora.addEventListener('input', function(e) {
        ...
        if(hora < 10 || hora > 18) {
            e.target.value = '';
            mostrarAlerta('* Hora no disponible', 'error', '.form');
        } else {
...
function mostrarResumen() {
    ...
    headingServicios.classList.add('text-left');
    ...
    headingCita.classList.add('text-left');
